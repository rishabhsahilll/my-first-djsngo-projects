    ...
    if request.user.is_authenticated:
        if request.method == 'POST':
            ...
            if imagepath is not None:
                user_profile = UserProfile.objects.create(image=imagepath)
            ...
            # print(img,user,first_name,surname,address_line1,address_line2,postcode,state,area,email,education,country,state_region)
